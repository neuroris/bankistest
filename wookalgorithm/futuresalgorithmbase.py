...
class FuturesAlgorithmBase(WookUtil, WookLog):
    ...
    def update_chart_prices_deprecated(self, item_code, price, volume):
    ...
    def get_current_time(self):
        ...
        multiplier = 1
        while self.candlestick_duration * multiplier <= 60:
            if current_time.second < self.candlestick_duration * multiplier:
                current_time = current_time.replace(second=(self.candlestick_duration * (multiplier - 1)))
                break
            multiplier += 1
